...
resultsqnny = qnn_y_flip(
    xs0, ys0, xs_val, ys_val, ave=5, dep=6, epo=100, bat=256, lr=0.005
)
resultsmlpy = mlp_y_flip(
    xs0, ys0, xs_val, ys_val, ave=5, hid=[64, 16], epo=100, bat=256, lr=0.005
)
...
resultsmlpy2 = mlp_y_flip(
    xs0, ys0, xs_val, ys_val, ave=5, hid=[16, 4], epo=100, bat=256, lr=0.005
)
resultsmlpx2 = mlp_x_poison(
    xs0, ys0, xs_val, ys_val, ave=5, hid=[16, 4], epo=100, bat=256, lr=0.005
)
np.save(
    "mnist_phase.npy",
    [resultsqnny, resultsmlpy, resultsqnnx, resultsmlpx, resultsmlpy2, resultsmlpx2],
)
